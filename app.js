/**
  ...
  *
**/
if ("undefined" == typeof CE2 && (CE2 = {}),
CE2.userDataToJs = function(e) {
    for (var t = [["uid", "uid"], ["snapshots", "snapshots"], ["status", "status"], ["flows", "flows"], ["pageEdits", "page_edits"], ["sites", "sites"], ["USER_SCRIPT_VERSION", "updated_at"], ["__CE_HOST__", "ce_app_url"], ["COMMON_SCRIPT", "common_script_url"], ["COMMON_SCRIPT_SECURE", "common_script_url"], ["TRACKING_SCRIPT", "tracking_script_url"], ["TRACKING_SCRIPT_SECURE", "tracking_script_url"], ["AUTH_KEY", "hud_auth_key"], ["HUD", "hud"], ["GLOBAL_IP_BLOCK_LIST", "global_ip_block_list"], ["IS_USING_IP_BLOCKING", "is_using_ip_blocking"], ["TRACKING_DEST_NEW", "v6_tracking_dest"], ["TRACKING_DEST_NEW_SECURE", "v6_secure_tracking_dest"], ["DEST_V11", "v11_tracking_dest"], ["FT_DEST", "flow_tracking_dest"], ["PAGE_VIEWS_LIMIT_REACHED", "page_views_limit_reached"], ["NUMBER_OF_RECORDINGS", "recordings_number"], ["RECORDINGS_ACTIVATION", "recordings_activation"], ["ERROR_TRACKING", "error_tracking"], ["DEST_ERRORS_API", "error_tracking_dest"], ["DEST_ERRORS_API_DOMAIN", "error_tracking_script_url"]], n = 0; n < t.length; n++) {
        var r = t[n];
...
function() {
    ...
    function n(e) {
        return r.getPrototypeOf = n = Object.setPrototypeOf ? Object.getPrototypeOf : function(e) {
    ...
    function i(e, t) {
        return r.setPrototypeOf = i = Object.setPrototypeOf || function(e, t) {
    ...
    ,
    r.createClass = function(e, t, n) {
        return t && o(e.prototype, t),
        n && o(e, n),
        e
    }
    ,
    r.defineProperty = function(e, t, n) {
    ...
    r.inherits = function(e, t) {
        ...
        t && r.setPrototypeOf(e, t)
    }
    ,
    r.getPrototypeOf = n,
    r.setPrototypeOf = i,
    r.assertThisInitialized = function(e) {
        if (void 0 === e)
            throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
        return e
    }
    ,
    r.possibleConstructorReturn = function(e, t) {
        return !t || "object" !== r.typeof(t) && "function" != typeof t ? r.assertThisInitialized(e) : t
    }
    ,
    r.readOnlyError = function(e) {
        throw Error('"' + e + '" is read-only')
    }
    ,
    r.slicedToArray = function(e, t) {
...
CE2.debug = function(e) {
    if (CE2.logHistoryEnabled && CE2.logHistory.push(e),
    !CE2.debugEnabled())
        return !1;
    var t = "string" == typeof e ? "CE: ".concat(e) : e;
    console.log(t),
    (e instanceof Error || e instanceof TypeError) && CE2.errorTracking && CE2.errorTracking.sendError && CE2.errorTracking.sendError(e)
}
,
CE2.errorTracking = function() {
    ...
    return e.sendError = function(e) {
        try {
            ...
            e.error && e.error.stack && (t.stack = e.error.stack.toString()),
            CE2.post.send((n = CE2.data.error_tracking_dest,
            "".concat(n, "?u=").concat(encodeURIComponent(CE2.data.uid))), CE2.JSON.stringify(t), {
                sendBeacon: !0
            }))
        } catch (e) {}
        var n
    ...
    e.listen = function() {
        var t, n = this;
        CE2.data.error_tracking_dest && CE2.data && CE2.data.uid && (t = CE2.data.error_tracking_script_url,
        window.addEventListener("error", function(e) {
            try {
                if (CE2.debug("Error Tacking: Error Event '".concat(e, "'")),
                !e.filename)
                    return;
                CE2.debug("Error Tacking: Error filename '".concat(e.filename, "'")),
                e.filename.includes(t) && n.sendError(e)
            } catch (e) {}
        }))
    }
    ,
...
CE2.data && CE2.data.error_tracking)
    try {
        CE2.debug("Starting Error Tracking"),
        CE2.errorTracking.listen()
    } catch (e) {
        CE2.debug(e)
    }
if ("undefined" == typeof CE2 && (CE2 = {}),
...
function() {
    ...
    /\bMSIE\b/.test(e) && (CE2.ie = 1,
    CE2.ieVersion = parseInt(/MSIE (\d+)\.\d+/.exec(e)[1], 10),
    CE2.ieQuirksMode = "BackCompat" == CE2.d.compatMode)
}(),
CE2.ignore = function(e) {
    e && (CE2.ignoredElements.push(e),
    CE2.tracker && CE2.tracker.ignoredElements.push(e))
}
,
CE2.capture = function(e) {
    CE2.clickCaptors.push(e),
    CE2.tracker && CE2.tracker.clickCaptors.push(e)
}
,
...
CE2.qs2obj = function(e, t) {
    if (null == e || /^\s*$/.test(e))
        return null;
    for (var n, r = {}, o = e.replace(/\+/g, " ").split(t || "&"), i = 0, a = o.length; i < a; i++)
        (n = o[i].split("="))[0] && (r[CE2.unescape(n[0])] = null == n[1] ? null : CE2.unescape(n[1]));
    return r
}
,
CE2.each = function(e, t, n) {
    if (e)
        if ("number" == typeof e.length && "function" == typeof e.concat)
            for (var r = 0, o = e.length; r < o && (c = e[r],
            !1 !== t.call(n, c, r)); r++)
                ;
        else
            for (var i = 0, a = Object.keys(e); i < a.length; i++) {
                var s = a[i]
                  , c = e[s];
                if (c !== Object.prototype[s] && !1 === t.call(n, c, s))
                    break
            }
}
,
...
,
CE2.userData = {},
CE2.set = function(e, t) {
    1 <= (e = parseInt(e, 10)) && e <= 5 && (CE2.userData[e] = "" + t),
    CE2.tracker && CE2.tracker.sendCustomUserData && CE2.tracker.sendCustomUserData()
}
,
CE2.sessionTags = [],
CE2.addTag = function(e) {
    if (Array.isArray(e))
...
CE2.click = function() {
    var e;
    if (CE2.tracker)
        return (e = CE2.tracker).click.apply(e, arguments)
}
,
CE2.getBox || (CE2.getBox = function() {}
),
CE2.sampleVisit = function(e) {
    return null == e.r || (!1 !== e.r && !0 !== e.r && (Math.random() >= 1 / e.r ? (CE2.debug("Snapshot ".concat(e.id, " not selected due to snapshot sampling: ").concat(e.r)),
    e.r = !1) : e.r = !0),
    e.r)
}
,
CE2.dontTrack = function(e, t, n, r) {
    if (r && void 0 !== e.external)
        try {
            if (!0 === e.external.InPrivateFilteringEnabled())
                return !0
        } catch (e) {}
...
CE2.getCookieDomain = function() {
    if (!CE2._tlDomain) {
        ...
        if (CE2.re.ipHost.test(e) || !/\./.test(e))
            CE2._tlDomain = e;
        else if (CE2.w.CE_COOKIE_DOMAIN && RegExp("(^|\\.)".concat(CE2.w.CE_COOKIE_DOMAIN.replace(/\./g, "\\."), "$"), "i").test(e))
            CE2._tlDomain = ".".concat(CE2.w.CE_COOKIE_DOMAIN);
        else
...
CE2.needSecureCookieForDomain = function(e) {
    return CE2.needSecureCookieCache && void 0 !== CE2.needSecureCookieCache[e] || (CE2.needSecureCookieCache || (CE2.needSecureCookieCache = {}),
    CE2.d.cookie = "ce_need_secure_cookie=1; domain=".concat(e),
    ~CE2.d.cookie.indexOf("ce_need_secure_cookie") ? (CE2.d.cookie = "ce_need_secure_cookie= ; domain=".concat(e, "; expires = Thu, 01 Jan 1970 00:00:00 GMT"),
    CE2.needSecureCookieCache[e] = !1) : CE2.needSecureCookieCache[e] = !0),
    CE2.needSecureCookieCache[e]
}
,
CE2.writeCookie = function(e, t, n) {
    ...
    t.push("path=".concat(i)),
    CE2.needSecureCookieForDomain(a) && (t.push("SameSite=None"),
    t.push("Secure")),
    a && t.push("domain=".concat(a)),
    s && t.push("expires=".concat(s.toUTCString())),
...
CE2.convertToFormData = function(e) {
    for (var t = new FormData, n = Object.keys(e), r = 0; r < n.length; r++)
        t.append(n[r], e[n[r]]);
    return t
}
,
...
CE2.normalizeSiteName = function(e) {
    ...
    return t.href = "http://".concat(e, "/"),
    t.hostname
}
,
CE2.getCurrentSite = function(e) {
    for (var t, n = 0; t = e[n++]; )
        if (CE2.matchSite(CE2.normalizeSiteName(t.name), CE2.w.location.hostname))
            return t
}
,
CE2.equalObjects = function(e, t) {
    var n = Object.getOwnPropertyNames(e);
    if (n.length != Object.getOwnPropertyNames(t).length)
        return !1;
...
CE2.matchURLRules = function(e) {
    ...
    if (e && e.length)
        for (t = 0; n = e[t++]; )
            if (CE2.matchURL(n.u, CE2.w.location.href, n.o))
                return !0;
    return !1
}
,
...
CE2.newBlob = function(t, e) {
    ...
    try {
        ...
        try {
            (n = new (CE2.w.BlobBuilder || CE2.w.WebKitBlobBuilder || CE2.w.MozBlobBuilder || CE2.w.MSBlobBuilder)).append(t.join()),
            n = n.getBlob()
        } catch (e) {
            return
        }
...
CE2.inlineWorker = function(e) {
    ...
    if ("undefined" != typeof CE_USER_COMMON_SCRIPT_URL)
        if ("undefined" != typeof CE_USER_THIRDPARTY_SCRIPT_URL)
            ...
            CE2.debug("Inline Worker is not supported: CE_USER_THIRDPARTY_SCRIPT_URL not defined");
    else
        CE2.debug("Inline Worker is not supported: CE_USER_SCRIPT_URL not defined")
}
,
...
function(e) {
    ...
    e.stringify = function(e, t, n) {
        ...
        "number" == typeof n)
            ...
            "string" == typeof n && (d = n);
        if ((E = t) && "function" != typeof t && ("object" !== CE2BH.typeof(t) || "number" != typeof t.length))
            throw Error("JSON.stringify");
        return function e(t, n) {
            var r, o, i, a, s, c = l, u = n[t];
            switch (u && "object" === CE2BH.typeof(u) && "[object Array]" !== Object.prototype.toString.apply(u) && "function" == typeof u.toJSON && (u = u.toJSON(t)),
            "function" == typeof E && (u = E.call(n, t, u)),
            CE2BH.typeof(u)) {
            case "string":
                return f(u);
            case "number":
            ...
            case "object":
                ...
                if (E && "object" === CE2BH.typeof(E))
                    for (a = E.length,
                    r = 0; r < a; r += 1)
                        "string" == typeof E[r] && (i = e(o = E[r], u)) && s.push(f(o) + (l ? ": " : ":") + i);
                else
                    for (o in u)
                        Object.prototype.hasOwnProperty.call(u, o) && (i = e(o, u)) && s.push(f(o) + (l ? ": " : ":") + i);
                return i = 0 === s.length ? "{}" : l ? "{\n" + l + s.join(",\n" + l) + "\n" + c + "}" : "{" + s.join(",") + "}",
                l = c,
                i
            }
...
"undefined" == typeof CE2 && (CE2 = {}),
CE2.matchURL = function(t, n, e, r, o, i) {
    var a, s, c, u, l = CE2.JSON.stringify, d = /(default|index)($|\..*)/i, E = !1;
    if (!t || !n)
        return !1;
    if (r && !~CE2.indexOf(r, CE2.deviceType(o)))
        return CE2.matchUrlDebug(i, "device=".concat(CE2.deviceType(o), " allowed=").concat(l(r)), C),
        !1;
    if (/n/.test(e = e || ""))
        return C = t.trim() == n.trim(),
        CE2.matchUrlDebug(i, "name=".concat(n, " allowed=").concat(t), C),
        C;
    if (/go/.test(e)) {
        var f = t.split(".")
          , C = n && n[f[0]] && n[f[0]].experiments && n[f[0]].experiments[f[1]] && n[f[0]].experiments[f[1]] == f[2];
        return CE2.matchUrlDebug(i, "googleOptimize=".concat(l(n), " allowed=").concat(l(t)), C),
        C
    }
    if (/[re]/.test(e))
        try {
            return C = RegExp(t, "i").test(n),
            CE2.matchUrlDebug(i, "url=".concat(n, " allowedregex=").concat(t), C),
            C
        } catch (e) {
            return CE2.matchUrlDebug(i, "url=".concat(n, " allowedregex=").concat(t)),
            !1
        }
    t = new CE2.URL(t);
    var p = new CE2.URL(n.toLowerCase());
    if (/h/.test(e) && t.protocol != p.protocol)
        return CE2.matchUrlDebug(i, "protocol=".concat(p.protocol, " allowed=").concat(t.protocol)),
        !1;
    var o = p.host
      , r = o.replace(/^(www|m)\./, "")
      , f = t.host
      , C = t.ihost;
    if (/w/.test(e) && o != f && o != C)
        return CE2.matchUrlDebug(i, "host=".concat(o, " allowed=").concat(C || f)),
        !1;
    f = f.replace(/^(www|m)\./, ""),
    C = C && C.replace(/^(www|m)\./, "");
    if (r != f && r != C)
    ...
    if (h != g) {
        if (/\//.test(e))
            return CE2.matchUrlDebug(i, "path=".concat(g, " allowed=").concat(h)),
            !1;
        for (s = h.split("/"),
        a = g.split("/"),
        c = 0,
        u = Math.max(s.length, a.length); c < u; c++)
            if (s[c] || (s[c] = ""),
            a[c] || (a[c] = ""),
            c == u - 1 && (s[c] = s[c].replace(d, ""),
            a[c] = a[c].replace(d, "")),
            s[c] != a[c])
                return CE2.matchUrlDebug(i, "path=".concat(g, " allowed=").concat(h)),
                !1
    ...
    var m = p.qs
      , y = t.qs || "";
    if ((f = /\?/.test(e)) && m && !y || !m && y)
        return CE2.matchUrlDebug(i, "querystring=".concat(l(m), " allowed=").concat(l(y))),
        !1;
    ...
    E)
        return CE2.matchUrlDebug(i, "querystring=".concat(l(m), " allowed=").concat(l(y))),
        !1;
    if (f && (CE2.each(m, function(e, t) {
        if (e != y[t])
            return E = !0
    }),
    E))
        return CE2.matchUrlDebug(i, "querystring=".concat(l(m), " allowed=strict|").concat(l(y))),
        !1;
    t = t.hash || "",
    p = p.hash || "";
    return ((f = /#/.test(e)) || t) && t != p ? (CE2.matchUrlDebug(i, "hash=".concat(p, " allowed=").concat(t)),
    !1) : (CE2.matchUrlDebug(i, "url=".concat(n), !0),
    !0)
}
,
...
,
"undefined" == typeof CE2 && (CE2 = {}),
void 0 === CE2.URL && (CE2.URL = function(e) {
    var t;
    this.src = e,
    this.protocol = this.host = this.port = this.path = this.qs = this.hash = this.query = null,
    e && ("string" == (t = CE2BH.typeof(e)) ? this.initWithString(e) : "object" == t && this.initWithURI(e))
}
,
CE2.URL.pattern = /^\s*([\S]+?:\/\/)?([^\s\/]+?@)?([^:\/\?\#]+)?(\:\d+)?(\/?[^#\?\s]*)?([\?][^#\s]*)?([#]\S+)?/i,
CE2.URL.prototype = {
    initWithString: function(e) {
        ...
        n[3])
          ...
          , t = n[6]
          , n = n[7];
        r || "/" == (e[0] || "") ? (r && (this.protocol = r.substr(0, r.indexOf(":"))),
        this.host = o || null,
        i && (this.port = +i.substr(1)),
        a ? this.path = CE2.unescape(a) : this.host && (this.path = "/")) : this.path = CE2.unescape((o || "") + (a || "")),
        t && (this.qs = CE2.qs2obj(t.substr(1)),
        this.query = t.substr(1)),
        n && (this.hash = CE2.unescape(n.substr(1)))
    },
...
"undefined" == typeof CE2 && (CE2 = {}),
CE2.deviceType = function(e) {
    var t, n = e.toLowerCase(), r = 0, o = e.indexOf("(");
    if (-1 == o)
        return 1;
    if (-1 != (t = e.indexOf("Android", ++o))) {
        if (e.length > (t += 8) && (r = e[0 | t] || ""))
            switch (r) {
            case "2":
                if (~e.indexOf("BNTV", t))
                    return 3;
                if (~n.indexOf("nook", t))
                    return 3;
                if (~e.indexOf("Kindle", t))
                    return 3;
                if (~e.indexOf("Touchpad", t))
                    return 3;
                break;
            case "3":
                return 3;
...
function(e) {
    ...
    n.Promise ? e.Promise = n.Promise : (t = setTimeout,
...
CE2.promisePool = function(u, l, d) {
...
CE2.cookieStorage = {
    ...
    load: function() {
        if (!this.values) {
            var e, t, n = {}, r = CE2.cookies[this.CK];
            if (r) {
                for (r = r.replace(/\\~/g, "\0").split("~"),
                e = 0; t = r[e]; e += 2)
    ...
    set: function(e, t) {
        var n = this;
        this.load(),
        this.values[e] = "".concat(t),
        null === this.saveTimeout && (this.saveTimeout = setTimeout(function() {
            n.saveTimeout = null,
            n.save()
        }, 10))
    },
...
CE2.rng = function() {
    ...
    return r && r.getRandomValues && (e = new Uint8Array(16),
    t = function() {
    ...
    t = function() {
        for (var e, t = 0; t < 16; t++)
            n[t] = (e = 0 == (3 & t) ? 4294967296 * Math.random() : e) >>> ((3 & t) << 3) & 255;
        return n
    }
    ),
    t
...
CE2.uuid_v1 = function() {
    ...
    return function(e, t, n) {
        var r = t && n || 0
          ...
          , n = a - E + (s - f) / 1e4;
        if (n < 0 && void 0 === e.clockseq && (i = i + 1 & 16383),
        1e4 <= (s = (n < 0 || E < a) && void 0 === e.nsecs ? 0 : s))
            throw Error("uuid.v1(): Can't create more than 10M uuids/sec");
        E = a,
        d = i;
        s = (1e4 * (268435455 & (a += 122192928e5)) + (f = s)) % 4294967296;
        o[r++] = s >>> 24 & 255,
        o[r++] = s >>> 16 & 255,
        o[r++] = s >>> 8 & 255,
        o[r++] = 255 & s;
...
CE2.d && (CE2.domReady = CE2.d.readyState && CE2.READY_STATE_PATTERN.test(CE2.d.readyState)),
CE2.domReadyListeners = [],
CE2.onDOMReady = function(e) {
    if (CE2.domReady)
...
CE2.domReadySetup = function() {
    function t() {
        for (var e = CE2.domReadyListeners; 0 < e.length; )
            e.pop().call();
        CE2.domReady = !0
    }
    var n;
    ...
    CE2.d.addEventListener && CE2.listen(CE2.d, "DOMContentLoaded", t),
    CE2.d.readyState && (n = CE2.READY_STATE_PATTERN,
    function e() {
    ...
    CE2.isBot = function() {
        return !(!(0 < arguments.length && void 0 !== arguments[0] && arguments[0]) && CE2.hasFeature("v11_disable_bot_detection")) && (!window.__CE_SCRIPT_CHECK && (e = e || ((e = void 0 === e ? function() {
            try {
                ...
                if (e)
                    return e;
                if (!navigator.language || navigator.languages && 0 === navigator.languages.length)
                    return "language";
                ...
                for (var t = ["__webdriver_evaluate", "__selenium_evaluate", "__webdriver_script_function", "__webdriver_script_func", "__webdriver_script_fn", "__fxdriver_evaluate", "__driver_unwrapped", "__webdriver_unwrapped", "__driver_evaluate", "__selenium_unwrapped", "__fxdriver_unwrapped"], n = ["webdriver", "_phantom", "__nightmare", "_selenium", "callPhantom", "callSelenium", "_Selenium_IDE_Recorder"], r = 0; r < n.length; r++) {
                    var o = n[r];
                    if (window[o])
                        return "windowKey: ".concat(o)
                }
                for (var i, a = 0; a < t.length; a++) {
                    var s = t[a];
                    if (window.document[s])
                        return "documentKey: ".concat(s)
                }
                for (i in window.document)
                    if (i.match(/\$[a-z]dc_/) && window.document[i].cache_)
                        return "chromeHeadlessCacheKey";
                if (window.external && window.external.toString() && ~window.external.toString().indexOf("Sequentum"))
                    return "sequentum";
                var c = window.document.documentElement;
                if (c.getAttribute("selenium") || c.getAttribute("webdriver") || c.getAttribute("driver"))
                    return "selenium";
                ...
                if (/Chrome|Chromium/i.test(navigator.userAgent)) {
                    ...
                    var d = document.createElement("canvas").getContext("webgl")
                      ...
                      , f = d.getParameter(E.UNMASKED_VENDOR_WEBGL)
                      , C = d.getParameter(E.UNMASKED_RENDERER_WEBGL);
                    if ("Brian Paul" === f && "Mesa OffScreen" === C)
...
function() {
    function s(e, t) {
        this.left = parseInt(e, 10),
        this.right = parseInt(t, 10)
    }
    function c(e) {
        this.parts = e
    }
...
function() {
    ...
    e.prototype = {
        onReady: function(n) {
            var e, r = this, t = this.localStorageGet();
            t ? (t = t.split(","),
            t = (e = CE2BH.slicedToArray(t, 2))[0],
            e = e[1],
            t && e && (this.diff = parseInt(t, 10),
            this.ip = e,
            this.valid = !0),
            n && n()) : (e = "".concat(CE2.data.clock_url, "?t=").concat(+new Date),
            CE2.get(e, function(e) {
                var t = e.responseText.split(",")
                  , e = CE2BH.slicedToArray(t, 2)
                  , t = e[0]
                  , e = e[1]
                  , t = parseInt(t, 10);
                0 < t && e && (r.diff = t = +new Date - t,
                r.ip = e,
                r.valid = !0,
                r.localStorageSet([t, e].join(","))),
                n && n()
            }))
        },
        ...
        getDate: function() {
            if (this.valid)
                return new Date(+new Date + this.diff)
        },
...
"undefined" == typeof CE2 && (CE2 = {}),
CE2.pointAt = function(e, t) {
    var n = document.createElement("img");
    n.src = "".concat(CE2.DEBUG_ROOT, "/images/pointer.gif"),
    n.className = "-ce-debug",
...
CE2.hilight = function(e, t, n, r, o) {
    ...
    i.className = "-ce-debug",
    i.style.position = "absolute",
    i.style.backgroundColor = o || "red",
...
CE2.log = function() {
    var e = CE2.logBox;
    e || ((e = CE2.d.createElement("textarea")).style.position = "fixed",
    ...
    for (var t = 0, n = arguments.length; t < n; t++)
        e.value += (t < 0 || arguments.length <= t ? void 0 : arguments[t]) + (0 < t ? " " : "");
    e.value += "\n",
...
CE2.summarize = function(e) {
    ...
    for (var t = [], n = 0, r = e.attributes.length; n < r; n++)
        t.push("".concat(e.attributes[n].nodeName, '="').concat(e.attributes[n].nodeValue, '"'));
...
CE2.browser = function() {
    ...
    var t = "unknown";
    return CE2.w && CE2.w.opera && "function" == typeof CE2.w.opera.version ? (t = "opera",
    CE2.opera = !0,
    CE2.operaVersion = parseInt(CE2.w.opera.version(), 10)) : /\bMSIE\b/.test(e) ? (t = "ie",
    CE2.ie = !0,
    ...
    CE2.iphone = !0,
    CE2.webkit = !0,
    /AppleWebKit/.test(navigator.appVersion) && (t = "safari",
    CE2.safari = !0)) : /\bChrome\b/.test(e) ? (t = "chrome",
    CE2.chrome = !0,
...
CE2.findByClass = function(e) {
    var t, n, r, o, i = [], a = CE2.d.body;
    if (a.getElementsByClassName ? r = a.getElementsByClassName(e) : a.querySelectorAll && (r = a.querySelectorAll(".".concat(e))),
    r)
        for (t = 0; n = r[t++]; )
            i.push(n);
    else
        for (r = a.getElementsByTagName("*"),
        o = RegExp("(^|\\s)".concat(e, "($|\\s)")),
        t = 0; n = r[t++]; )
            n.className && o.test(n.className) && i.push(n);
    return i
}
,
CE2.formatClass = function(e) {
    ...
    if (e && "string" == typeof e)
        return (e = CE2.strip(e.replace(/(\s|^)-ce-capture\b/g, "")).split(/\s+/)).sort(),
        e.join(" ")
}
,
CE2.href = function(e) {
...
CE2.contains = function(e, t) {
    ...
    if ("function" == typeof e.contains)
        return e.contains(t);
    for (var n = t; (n = n.parentNode) && n != document.body && n != e; )
        ;
    return n == e
}
,
...
CE2.querySelectorAll = function(e, t) {
    ...
    if (n.querySelectorAll)
        return t ? n.querySelector(e) : n.querySelectorAll(e);
    for (var r, o = [], i = n.all, a = n.createStyleSheet(), s = (e = e.split(/\s*,\s*/)).length; s--; ) {
        for (a.addRule(e[s], "k:v"),
        r = i.length; r--; )
...
CE2.makeId = function(e, t) {
    var n, r, o, i = CE2.w.crypto, a = "function" == typeof CE2.w.btoa && CE2.w.btoa, s = "";
    if (e = e || 20,
    i && i.getRandomValues) {
    ...
    if (t && a)
        return a(s = n.map(function(e) {
            return String.fromCharCode(e)
        }).join("")).replace(/\+/g, "-").replace(/\//g, "_").replace(/\=+$/, "");
    for (r = 0; r < e; r++)
        s += (o = n[r].toString(16)).length < 2 ? "0".concat(o) : o;
    return s
}
,
...
CE2.assign = function() {
    ...
    if (1 === arguments.length)
        return r;
    var o, i = Array.prototype.slice.call(t), a = i[1];
    for (o in a)
        Object.prototype.hasOwnProperty.call(a, o) && (r[o] = a[o]);
    return i.splice(1, 1),
    CE2.assign.apply(this, i)
}
,
...
,
"undefined" == typeof CE2 && (CE2 = {}),
CE2.URL.prototype.join = function(e) {
    var t = new CE2.URL(this)
      , n = this.path;
    return (e = "string" == typeof e ? new CE2.URL(e) : e).isURL() ? new CE2.URL(e) : (n = e.isAbsolute() ? e.path : n ? ((n = n.split("/")).pop(),
    (n = e.path ? n.concat(e.path.split("/")) : n).join("/")) : this.isURL() ? "/".concat(e.path) : e.path,
    t.path = n,
    t.qs = e.qs,
    t.hash = e.hash,
    t)
...
CE2.URL.prototype.normalize = function() {
    if (this.path) {
        ...
        "/" == (this.path[0 | this.path.length - 1] || "") && e.push("")) : e = this.path.split(/\/+/g);
        var t, n = 0;
        do {
            if (t = e.length - 1,
            ".." == e[n + 1])
...
CE2.URL.prototype.simplify = function(e) {
    var n, t = [], e = "file" == this.protocol ? this : CE2.ie ? e ? e.join(this) : this : (e = e || new CE2.URL(CE2.d.baseURI)).join(this);
    return e.normalize(),
    e.host && t.push(e.host.replace(/^(www|m)\./, "")),
    null != e.port && t.push(":".concat(e.port)),
    "/" == e.path || /^\/(default|home|index)\b[^\/]*$/i.test(e.path) ? (e.qs || e.hash) && t.push("/") : t.push(e.path),
    e.qs && (n = [],
    CE2.each(e.qs, function(e, t) {
        e && !/(^sess|^sid$|^phpsessid$|^jsessionid$|^__VIEWSTATE$)/i.test(t) && n.push("".concat(encodeURIComponent(t), "=").concat(encodeURIComponent(e)))
    }),
    n.length && t.push("?".concat(n.join("&")))),
    e.hash && t.push("#".concat(e.hash)),
    t.join("")
}
,
    ...
    function t() {
        ...
        this.__append = function(e) {
            ...
            if ("string" == typeof e)
                ...
                for ((t = (e = !("byteOffset"in e) ? new Uint8Array(e) : e).byteLength); n < t; ++n)
                    r.push(255 & e[n])
        }
    }
    t.prototype.append = function(e, t, n) {
        if (this.__endedMultipart && (this.data.length -= this.boundary.length + 6,
        this.__endedMultipart = !1),
        arguments.length < 2)
            throw new SyntaxError("Not enough arguments");
        var r = "--".concat(this.boundary, "\r\n") + 'Content-Disposition: form-data; name="'.concat(e, '"');
        if ("undefined" != typeof File && t instanceof File || "undefined" != typeof Blob && t instanceof Blob)
            return this.append(e, new Uint8Array((new FileReaderSync).readAsArrayBuffer(t)), n || t.name);
...
CE2.cleanPrototype = function(e) {
    ...
    return n || ((n = document.createElement("iframe")).id = t,
...
CE2.XMLHttpRequest || Object.defineProperty(CE2, "XMLHttpRequest", {
    get: function() {
        return CE2._xmlHttpRequest || CE2.isNativeFunction(XMLHttpRequest.prototype.send) || (CE2._xmlHttpRequest = CE2.cleanPrototype("XMLHttpRequest")),
        CE2._xmlHttpRequest || XMLHttpRequest
    }
}),
CE2.testModeRequests = [],
CE2.get = function(e, t, n) {
    var r = new CE2.XMLHttpRequest;
...
CE2.post = {
    send: function(e, t) {
        ...
        CE2.testModeCheck() ? CE2.testModeRequests.push({
            ...
            data: t,
            options: i
        }) : (n = i.sendBeacon && CE2.n && CE2.n.sendBeacon,
        r = i.contentType || "text/plain",
        n && CE2.n && CE2.n.sendBeacon ? (CE2.n.sendBeacon(e, t),
        i.callback && i.callback()) : "undefined" != typeof XMLHttpRequest ? ((o = new CE2.XMLHttpRequest).onreadystatechange = function() {
            i.callback && 4 == o.readyState && i.callback(o)
        }
        ,
        o.open(i.method || "POST", e),
        t instanceof CE2.FormData && (t.__endedMultipart || t.__append("--".concat(t.boundary, "--\r\n")),
        t.__endedMultipart = !0,
        r = "multipart/form-data; boundary=".concat(t.boundary),
        t = new Uint8Array(t.data)),
        o.setRequestHeader("Content-type", r),
        o.send(t)) : CE2.debug("XMLHttpRequest not supported"))
    },
    ...
    encodeParams: function(e) {
        ...
        return CE2.each(e, function(e, t) {
            null != e && CE2.strip("".concat(e)) && (n.length && (n += "&"),
            n += "".concat(r(t), "=").concat(r(e)))
        }),
        n
    }
},
...
function() {
    ...
    function a(e, t) {
        ...
        e[t >> 5] |= 128 << t % 32,
        e[14 + (t + 64 >>> 9 << 4)] = t;
        for (var a = 1732584193, s = -271733879, c = -1732584194, u = 271733878, l = 0; l < e.length; l += 16)
            a = E(n = a, r = s, o = c, i = u, e[l], 7, -680876936),
            u = E(u, a, s, c, e[l + 1], 12, -389564586),
            c = E(c, u, a, s, e[l + 2], 17, 606105819),
            s = E(s, c, u, a, e[l + 3], 22, -1044525330),
            a = E(a, s, c, u, e[l + 4], 7, -176418897),
            u = E(u, a, s, c, e[l + 5], 12, 1200080426),
            c = E(c, u, a, s, e[l + 6], 17, -1473231341),
            s = E(s, c, u, a, e[l + 7], 22, -45705983),
            a = E(a, s, c, u, e[l + 8], 7, 1770035416),
            u = E(u, a, s, c, e[l + 9], 12, -1958414417),
            c = E(c, u, a, s, e[l + 10], 17, -42063),
            s = E(s, c, u, a, e[l + 11], 22, -1990404162),
            a = E(a, s, c, u, e[l + 12], 7, 1804603682),
            u = E(u, a, s, c, e[l + 13], 12, -40341101),
            c = E(c, u, a, s, e[l + 14], 17, -1502002290),
            a = f(a, s = E(s, c, u, a, e[l + 15], 22, 1236535329), c, u, e[l + 1], 5, -165796510),
            u = f(u, a, s, c, e[l + 6], 9, -1069501632),
            c = f(c, u, a, s, e[l + 11], 14, 643717713),
            s = f(s, c, u, a, e[l], 20, -373897302),
            a = f(a, s, c, u, e[l + 5], 5, -701558691),
            u = f(u, a, s, c, e[l + 10], 9, 38016083),
            c = f(c, u, a, s, e[l + 15], 14, -660478335),
            s = f(s, c, u, a, e[l + 4], 20, -405537848),
            a = f(a, s, c, u, e[l + 9], 5, 568446438),
            u = f(u, a, s, c, e[l + 14], 9, -1019803690),
            c = f(c, u, a, s, e[l + 3], 14, -187363961),
            s = f(s, c, u, a, e[l + 8], 20, 1163531501),
            a = f(a, s, c, u, e[l + 13], 5, -1444681467),
            u = f(u, a, s, c, e[l + 2], 9, -51403784),
            c = f(c, u, a, s, e[l + 7], 14, 1735328473),
            a = C(a, s = f(s, c, u, a, e[l + 12], 20, -1926607734), c, u, e[l + 5], 4, -378558),
            u = C(u, a, s, c, e[l + 8], 11, -2022574463),
            c = C(c, u, a, s, e[l + 11], 16, 1839030562),
            s = C(s, c, u, a, e[l + 14], 23, -35309556),
            a = C(a, s, c, u, e[l + 1], 4, -1530992060),
            u = C(u, a, s, c, e[l + 4], 11, 1272893353),
            c = C(c, u, a, s, e[l + 7], 16, -155497632),
            s = C(s, c, u, a, e[l + 10], 23, -1094730640),
            a = C(a, s, c, u, e[l + 13], 4, 681279174),
            u = C(u, a, s, c, e[l], 11, -358537222),
            c = C(c, u, a, s, e[l + 3], 16, -722521979),
            s = C(s, c, u, a, e[l + 6], 23, 76029189),
            a = C(a, s, c, u, e[l + 9], 4, -640364487),
            u = C(u, a, s, c, e[l + 12], 11, -421815835),
            c = C(c, u, a, s, e[l + 15], 16, 530742520),
            a = p(a, s = C(s, c, u, a, e[l + 2], 23, -995338651), c, u, e[l], 6, -198630844),
            u = p(u, a, s, c, e[l + 7], 10, 1126891415),
            c = p(c, u, a, s, e[l + 14], 15, -1416354905),
            s = p(s, c, u, a, e[l + 5], 21, -57434055),
            a = p(a, s, c, u, e[l + 12], 6, 1700485571),
            u = p(u, a, s, c, e[l + 3], 10, -1894986606),
            c = p(c, u, a, s, e[l + 10], 15, -1051523),
            s = p(s, c, u, a, e[l + 1], 21, -2054922799),
            a = p(a, s, c, u, e[l + 8], 6, 1873313359),
            u = p(u, a, s, c, e[l + 15], 10, -30611744),
            c = p(c, u, a, s, e[l + 6], 15, -1560198380),
            s = p(s, c, u, a, e[l + 13], 21, 1309151649),
            a = p(a, s, c, u, e[l + 4], 6, -145523070),
            u = p(u, a, s, c, e[l + 11], 10, -1120210379),
            c = p(c, u, a, s, e[l + 2], 15, 718787259),
            s = p(s, c, u, a, e[l + 9], 21, -343485551),
            a = d(a, n),
            s = d(s, r),
            c = d(c, o),
            u = d(u, i);
    ...
    function r(e) {
        for (var t, n = "0123456789abcdef", r = "", o = 0; o < e.length; o += 1)
            r += (n[0 | (t = e.charCodeAt(o)) >>> 4 & 15] || "") + (n[0 | 15 & t] || "");
        return r
    }
    function n(e) {
    ...
    function i(e, t) {
        return function(e, t) {
            ...
            n = 0; n < 16; n += 1)
                o[n] = 909522486 ^ r[n],
                i[n] = 1549556828 ^ r[n];
            return t = a(o.concat(u(t)), 512 + 8 * t.length),
            c(a(i.concat(t), 640))
        }(n(e), n(t))
    }
...
CE2.Map.prototype = {
    ...
    put: function(e, t) {
        var n = this._get(e);
        return n ? n[1] = t : this._dict.push([e, t]),
        delete this.keysCache,
        this
    },
    get: function(e) {
        e = this._get(e);
...
CE2.identify = function(e) {
    e && (CE2.tracker && CE2.tracker.identify && CE2.tracker.identify(e),
    CE2.IDENTIFIER = e)
}
,
"undefined" == typeof CE2 && (CE2 = {}),
function() {
    ...
    function e(e) {
        this.site = e,
        this.clock = CE2.clock,
        this.ratio = CE2.ratioForSite(e)
    }
    CE2.ratioForSite = function(e) {
        if (CE2.data.sites_sampling)
            for (var t = 0, n = CE2.data.sites_sampling; t < n.length; t++) {
                var r = n[t];
                if (r.id === e.id)
                    return parseInt(r.recording_ratio, 10)
            }
    }
    ,
    e.prototype = {
        ...
        canRecord: function() {
            if ("undefined" != typeof CE_ENFORCE_RECORDING && CE_ENFORCE_RECORDING)
                return this.debug("CE_ENFORCE_RECORDING applied"),
                this._setAppliedStrategy("enforced"),
                !0;
            if (this.ratio <= 0)
                return this.debug("Sampling Ratio: Zeroed Ratio"),
                !1;
            var e = CE2.cookieStorage.get(r);
            if (e && +new Date - parseInt(e, 10) < 18e5)
                return this.debug("Sampling Ratio: Standby"),
                !1;
            if (this.debug("Sampling Ratio: ".concat(this.ratio)),
            Math.random() * this.ratio < 1) {
                var t, n = !1;
                return this.appliedStrategy = this._strategy(),
                n = "custom" === this._strategy() ? ((t = this.customSamplingApplies()) ? this._setAppliedStrategy("custom") : this.customPeriodEnded() && (t = !0,
                this._setAppliedStrategy("uniform")),
                this.debug("Sampling Ratio Applies: ".concat(t)),
                t) : ("consecutive" == this._strategy() ? ((t = this.consecutiveSamplingApplies()) ? this._setAppliedStrategy("consecutive") : this._setAppliedStrategy("uniform"),
                this.debug("Sampling Ratio Applies: ".concat(t))) : (this._setAppliedStrategy("uniform"),
                this.debug("Sampling Ratio: Recording")),
                !0),
                CE2.cookieStorage.del(r),
                n
            }
            return this.debug("Sampling Ratio: Not This Time"),
            CE2.cookieStorage.set(r, +new Date),
            !1
        },
        _setAppliedStrategy: function(e) {
            this.appliedStrategy = e,
            CE2.appliedStrategy = e
        },
...
function() {
    ...
    o.prototype = {
        ...
        isEnded: function() {
            ...
            return !!(this.id && e && 3e5 < +new Date - e) || (this.del(n),
            !1)
        },
...
CE2.V11Network = function() {
    ...
    return {
        slow: function() {
            if (CE2.hasFeature("v11_record_slow_network"))
                return !1;
            try {
                    ...
                    if (performance && performance.getEntriesByType) {
                        ...
                        if (!(void 0 === e || e.length <= 0)) {
                            for (var t, n, r = 0; r < e.length; r++) {
                                var o = e[r];
                                (t = /pages\/versioned\/tracking\-scripts/.test(o.name) ? o : t) || "undefined" == typeof CE_USER_COMMON_SCRIPT_URL || o.name !== CE_USER_COMMON_SCRIPT_URL || (t = o),
                                /pages\/data\-scripts\//.test(o.name) && (n = o)
                            }
                ...
                var e = n();
                return CE2.debug("V11 Networking: slow? ".concat(e)),
                e
            } catch (e) {
                return CE2.debug(e),
                !1
...
CE2.userSessionMatchPageTargeting = function(e) {
    var t, n, r = e.rules;
    if (CE2.data.disable_recordings_mobile && 1 !== CE2.deviceType(CE2.n.userAgent))
        return !1;
    if (e.pageTargetingEnabled && r && r.length) {
        for (t = 0; n = r[t++]; )
            if (CE2.matchURL(n.u, CE2.w.location.href, n.o, null, null, CE2.sessionMatchCallbackDebug(n)))
                return !0;
        return !1
    }
    return CE2.debug("Session page match for url ".concat(CE2.w.location.href)),
    !0
}
,
...
CE2.userSessionMatching = function(e) {
    if (e.sessionRecording) {
        if (!(e.recordingSettings && e.recordingSettings.recordIframes) && CE2.w.parent !== CE2.w) {
            ...
            if (t && ~t.indexOf(n))
                return void CE2.debug("Session recording prevented from iframe")
        }
        ...
        if (CE2.V11Session.exists()) {
            ...
            if (!n.isExpired())
                return o && e.recordingSettings.endSessionOnBlockedUrl ? (n.reset(),
                void CE2.notTrackingCallback("Session page blocked and marked to end")) : t.slow() ? (n.reset(),
                void CE2.notTrackingCallback("Session network is too slow. Ending Session")) : (CE2.debug("Session continued"),
                n);
            n.reset(),
            CE2.debug("Session expired")
        }
        if (r) {
            if (!o) {
                if (t.slow())
                    return CE2.debug("Session network is too slow. Dont start a session"),
                    !1;
                e = new CE2.Ratio(e);
                return e.validRatio() && e.canRecord() ? (CE2.debug("Session sampling accepted, starting new session"),
                new CE2.V11Session) : (CE2.debug("Session sampling rejected"),
                !1)
            }
            CE2.debug("Session page blocked")
        } else
            CE2.debug("Session page didn't match")
    } else
        CE2.debug("Session recording disabled")
}
,
CE2.findMatchingSnapshot = function(e, t, n, r, o, i) {
    var a, s;
    if (e && e.length) {
        for (var c = CE2.clock.getDateUnix(), u = 0; a = e[u++]; )
            a.e && (!c || a.e <= c) ? CE2.snapshotMatchDebug(a, "expired") : n && !/n/.test(a.o || "") || o && !/go/.test(a.o || "") ? CE2.snapshotMatchDebug(a, "not named snapshot") : a.s && (!c || a.s > c) ? (CE2.snapshotMatchDebug(a, "pending"),
            CE2.p[a.id] = a) : CE2.isMatchingSnapshot(a, t, n, r, o, i) && (s = s || a,
            CE2.scriptCheckMatchingSnapshots || (CE2.scriptCheckMatchingSnapshots = []),
            ~CE2.scriptCheckMatchingSnapshots.indexOf(a.id) || CE2.scriptCheckMatchingSnapshots.push(a.id));
        return s
    }
}
,
CE2.isMatchingSnapshot = function(e, t, n, r, o, i) {
    if (void 0 === e.isBlocked && (e.isBlocked = new CE2.IPBlockList(e.ip).blocked(i)),
    e.isBlocked)
        return CE2.snapshotMatchDebug(e, "IP blocked"),
        !1;
    if (CE2.isBot())
        return CE2.snapshotMatchDebug(e, "bot blocked"),
        !1;
    if (r) {
        i = r == e.vid;
        return CE2.snapshotMatchDebug(e, "variantid=".concat(r, " allowed=").concat(e.vid), i),
        i
    }
    return !r && e.vid ? (CE2.snapshotMatchDebug(e, "variantid=".concat(r, " allowed=").concat(e.vid)),
    !1) : o ? CE2.matchURL(e.u, o, e.o, e.d, CE2.n.userAgent, CE2.snapshotMatchCallbackDebug(e)) : CE2.matchURL(e.u, n || t, e.o, e.d, CE2.n.userAgent, CE2.snapshotMatchCallbackDebug(e))
}
,
...
CE2.userSnapshotMatching = function(e, t, n, r, o) {
    ...
    var i, a = null, s = null;
    return r && (a = CE2.findMatchingSnapshot(e, t, n, r, null, CE2.clock.getIP())),
    o && (s = CE2.findMatchingSnapshot(e, t, n, null, o, CE2.clock.getIP())),
    i = CE2.findMatchingSnapshot(e, t, n, null, null, CE2.clock.getIP()),
    a || s || i
}
,
CE2.startTracking = function(e, t, n, r) {
    var o, i = [];
    if (e && i.push("SNAPSHOT_ID=".concat(e.id)),
    n && i.push("SESSION=".concat(n.id || n)),
    e && CE2.sampleVisit(e) && (o = e.id,
    CE2.testID = e.id,
    CE2.testVersion = e.v || 1),
    CE2.tracker)
        return CE2.tracker.visitor && i.push("VISITOR=".concat(CE2.tracker.visitor.getId())),
        CE2.debug("Updating Tracker TRACKER=11 ".concat(i.join(" "))),
        void CE2.tracker.update(o, n, r);
    o || n ? (CE2.tracker = new CE2.V11Tracker(11,CE2.VERSION,o,n,CE2.getCensoredElements(t),null,t),
    i.push("VISITOR=".concat(CE2.tracker.visitor.getId())),
    CE2.debug("Starting Tracker TRACKER=11 ".concat(i.join(" ")))) : CE2.debug("Tracker not started ".concat(i.join(" ")))
}
,
CE2.startTestModeTracking = function() {
    CE2.debug("Starting Test Mode Tracker TRACKER=11"),
    CE2.tracker = new CE2.V11Tracker(11,CE2.VERSION,"testsnapshot",new CE2.V11Session),
    CE2.tracker.testMode = !0
}
,
CE2.loadSamplingData = function(e) {
    var t = new CE2.XMLHttpRequest
      , n = parseInt(+new Date / 36e5, 10);
    t.onreadystatechange = function() {
        if (4 == t.readyState)
            try {
                200 == t.status && t.responseText && (CE2.data.samplingData = JSON.parse(t.responseText),
                e())
            } catch (e) {
    ...
    ,
    CE2.debug("Loading sampling user data ".concat(CE2.data.sampling_data_url)),
    t.open("GET", "".concat(CE2.data.sampling_data_url, "?t=").concat(n), !0),
    t.send()
}
,
CE2.userDataMain = function() {
    CE2.debug("Starting CrazyEgg v".concat(CE2.VERSION)),
    CE2.testModeCheck() ? CE2.userMainTestMode() : CE2.data ? CE2.loadSamplingData(function() {
        CE2.userMain()
    }) : CE2.data || "string" != typeof CE_USER_DATA_URL ? CE2.debug("No CE2.data nor CE_USER_DATA_URL found, stopping.") : (CE2.debug("No CE2.data, loading user data for CE_USER_DATA_URL=".concat(CE_USER_DATA_URL, ".")),
    CE2.get(CE_USER_DATA_URL, function(e) {
        CE2.data = CE2.parseJSON(e.responseText),
        CE2.userDataToJs && CE2.userDataToJs(CE2.data),
        CE2.loadSamplingData(function() {
            CE2.userMain()
        })
    }))
}
...
CE2.canRun = function() {
    try {
        localStorage.setItem("ce_localstorage_test", ""),
        localStorage.removeItem("ce_localstorage_test", "")
    } catch (e) {
        return "localStorage not available"
    }
    var e = "ce_cookie_check";
    return CE2.writeCookie(e, "cookie"),
    ~document.cookie.indexOf(e) ? (CE2.deleteCookie(e),
    !0) : "cookies not available"
}
,
CE2.hasFeature = function(e) {
    if (!CE2.data || !CE2.data.features)
        return !1;
...
CE2.userMain = function() {
    try {
        var c, e = CE2.data, u = e.snapshots, t = e.sites, n = CE2.data.global_ip_block_list, r = CE2.canRun();
        if (!0 !== r)
            return void CE2.notTrackingCallback("Not tracking: can't run - ".concat(r));
        var o = CE2.isBot();
        if (o)
            return void CE2.notTrackingCallback("Not tracking: bot detected - ".concat(o));
        if (CE2.dontTrack(CE2.w, CE2.d, CE2.n, CE2.ie))
            return void CE2.notTrackingCallback("Not tracking: doNotTrack detected.");
        ...
        function a(e) {
            for (var t, n = "", r = /(![^:\/a-z])|([^:\/a-z]{2})|(:[^:\/a-z]{3})|(\/[^:\/a-z]{4})/gi, o = String.fromCharCode; null != (t = r.exec(e)); )
                t[1] || t[2] ? n += o(i(t[0])) : t[3] ? n += o(i(t[3].substr(1))) : t[4] && (n += o(i(t[4].substr(1))));
            return n
        }
        var l, s = function() {
            for (var e = "!$%&()*+,-.0123456789;<=>?@[]^_`{|}~", t = {}, n = 0; n < 36; n++)
                t[e[0 | n] || ""] = n.toString(36);
            return t
        }();
        "string" == typeof u && (u = CE2.parseJSON(a(u))),
        "string" == typeof t && (t = CE2.parseJSON(a(t))),
        n = a(n),
        (l = t ? CE2.getCurrentSite(t) : l) ? (!CE2.data.sites_sampling && CE2.data.samplingData && CE2.data.samplingData.sites_sampling && (CE2.data.sites_sampling = JSON.parse(a(CE2.data.samplingData.sites_sampling))),
        CE2.clock = new CE2.Clock,
        CE2.clock.onReady(function() {
            new CE2.IPBlockList(n).blocked(CE2.clock.getIP()) ? CE2.debug("IP Blocked: ".concat(CE2.clock.getIP())) : (CE2.monitor = function() {
                try {
                    var e, t = CE2.w.location.href, n = c && c.flow && c.flow.trackByVariant && c.variant.variantId, r = "string" == typeof CE_SNAPSHOT_NAME && CE_SNAPSHOT_NAME.trim(), o = CE2.w.gaData, i = !1, a = CE2.monitorSession, s = CE2.monitorSnapshot;
                    if (CE2.monitorPageUrl == t && CE2.monitorVariantId == n && CE2.monitorGaData == CE2.JSON.stringify(o) && CE2.monitorCESnapshotName == r)
                        return;
                    if (CE2.monitorPageUrl !== t && (i = !0),
                    u && u.length || CE2.debug("No active snapshots to evaluate, or user is above snapshots quota."),
                    CE2.monitorPageUrl = t,
                    CE2.monitorVariantId = n,
                    CE2.monitorGaData = CE2.JSON.stringify(o),
                    CE2.monitorCESnapshotName = r,
                    CE2.logHistoryEnabled = !0,
                    i && (a = CE2.userSessionMatching(l)),
                    (s = u && u.length && !(s = CE2.userSnapshotMatching(u, t, r, n, o)) && r ? CE2.userSnapshotMatching(u, t, null, n, o) : s) && (CE2.debug("Snapshot ".concat(s.id, " selected")),
                    CE2.scriptCheckSelectedSnapshot = s.id),
                    CE2.hasFeature("v11_session_logs") && a && a.isNew && (e = CE2.logHistory.map(function(e) {
                    ...
                    CE2.logHistoryEnabled = !1,
                    CE2.logHistory = [],
                    a === CE2.monitorSession && s === CE2.monitorSnapshot)
                        return;
                    CE2.monitorSession = a,
                    CE2.monitorSnapshot = s,
                    a ? CE2.loadSessionTrackingScript(function() {
...
CE2.resetTracker = function() {
    CE2.testID = CE2.testVersion = CE2.scriptCheckMatchingSnapshots = CE2.scriptCheckSelectedSnapshot = null,
...
CE2.startMonitor = function() {
    ...
    CE2.monitor && !CE2.isBot() && (CE2.monitor(),
    CE2.autoStart && (CE2.monitorInterval = setInterval(CE2.monitor, 1e3)))
}
,
CE2.showWebsite = function() {
    CE2.bh && (CE2.bh.parentElement.removeChild(CE2.bh),
    CE2.bh = null)
}
,
CE2.autoStart && CE2.onDOMReady(CE2.userDataMain),
"function" == typeof CE_READY ? CE2.onDOMReady(CE_READY) : "object" === ("undefined" == typeof CE_READY ? "undefined" : CE2BH.typeof(CE_READY)) && CE2.onDOMReady(function() {
    CE2.each(CE_READY, function(e) {
        if ("function" == typeof e)
            try {
                e()
            } catch (e) {
                CE2.debug("CE2.userMain error:"),
                CE2.debug(e)
            }
    })
}),
"undefined" == typeof CE2 && (CE2 = {}),
CE2.loadHUD = function() {
    try {
        return CE2.loadedHUD ? !1 : (CE2._addHUDLoaderScript(),
        CE2.loadedHUD = !0,
        window.localStorage.setItem("powerup", "true"),
        !0)
    } catch (e) {
        return CE2.debug(e),
        !1
...
CE2._addHUDLoaderScript = function() {
    function t(e) {
        if ("string" == typeof CE2_HUD_SCRIPT_URL)
            t = CE2_HUD_SCRIPT_URL;
        else {
            if (!e)
                return void CE2.debug("Unable to determine HUD script URL. No version given.");
...
CE2.checkHUDLocalStorage = function() {
    try {
        return void 0 === window.localStorage ? !1 : void 0 !== window.localStorage.getItem && (!!window.localStorage.getItem("powerup") && (CE2.loadHUD(),
        !0))
    } catch (e) {
        return CE2.debug(e),
        !1
...
CE2.checkHUDHashFragment = function() {
    try {
        return document.location.hash.indexOf("#powerup") && document.location.hash.indexOf("#ce-") ? !1 : (CE2.loadHUD(),
        !0)
    } catch (e) {
        return CE2.debug(e),
        !1
...
,
CE2.data && CE2.data.hud)
    try {
        CE2.checkHUDLocalStorage(),
        window.addEventListener("hashchange", CE2.checkHUDHashFragment),
        CE2.checkHUDHashFragment()
    } catch (e) {
        CE2.debug(e)
    }
